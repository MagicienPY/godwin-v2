...
## img
        image_pil = Image.open(f"/home/magicien/Documents/GODWIN-main/photo_user/{result5[4]}")
        # Définir la nouvelle taille souhaitée
        nouvelle_taille = (50, 50)
...
#fin frame interne
   ...
   #bare de menu
       ...
       # monb.generer_bulletin()
        ...
        filemenu.add_command(label="Ajouter Etudiant",command=lambda: aj.ajoue())
        ...
        filemenu.add_command(label="bul individuel",command= monb.generer_bulletin())
